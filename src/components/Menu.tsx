...
const Menu = (): ReactElement =>  {
    ...
    return (
        <div className="flex items-center justify-between space-x-16 md:space-x-0 lg:space-x-0 min-w-100 h-24 bg-sga-red px-5">
            <div>
            ...
            <svg aria-label="menu icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-12 h-12 sm:hidden">
